...
const HeroSection = () => {
  return (
    <div className='dark:bg-black dark:bg-grid-white/[0.09] h-auto md:h-[40rem] w-full rounded-md flex flex-col item-center justify-center relative overflow-hidden mx-auto py-10 md:py-0'>
         <Spotlight
